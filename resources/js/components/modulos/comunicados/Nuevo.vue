                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <el-input
                                    ...
                                    clearable
                                    :disabled="comunicado.existe_asignaciones"
                                >
                                </el-input>
                                <span
                                    class="error invalid-feedback"
    ...
    methods: {
        ...
        setRegistroModal() {
            ...
            try {
                ...
                formdata.append(
                    "grupo_id",
                    this.comunicado.grupo_id ? this.comunicado.grupo_id : ""
                );
                formdata.append(
                    "titulo",
                    this.comunicado.titulo ? this.comunicado.titulo : ""
                );
                formdata.append(
                    "descripcion",
                ...
                if (this.accion == "edit") {
                    url = main_url + "/admin/comunicados/" + this.comunicado.id;
