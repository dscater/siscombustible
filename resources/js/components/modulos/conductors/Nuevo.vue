                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label
                                    :class="{
                                        'text-danger': errors.licencia,
                                    }"
                                    >Licencia Categoría*</label
                                >
                                <el-input
                                    placeholder="Licencia Categoría"
                                    :class="{ 'is-invalid': errors.licencia }"
                                    v-model="usuario.licencia"
                                    clearable
                                >
                                </el-input>
                                <span
                                    class="error invalid-feedback"
                                    v-if="errors.licencia"
                                    v-text="errors.licencia[0]"
                                ></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label
    ...
    methods: {
        setRegistroModal() {
            ...
            try {
                ...
                let url = main_url + "/admin/conductors";
                let config = {
                    headers: {
                ...
                formdata.append(
                    "licencia",
                    this.usuario.licencia ? this.usuario.licencia : ""
                );
                formdata.append(
                    "observacion",
                ...
                if (this.accion == "edit") {
                    url = main_url + "/admin/conductors/" + this.usuario.id;
