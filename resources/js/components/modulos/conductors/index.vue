...
export default {
    ...
    methods: {
        ...
        editarRegistro(item) {
            ...
            this.oUsuario.licencia = item.conductor.licencia
                ? "" + item.conductor.licencia
                : "";
            this.oUsuario.observacion = item.conductor.observacion
                ? "" + item.conductor.observacion
                : "";
        ...
        eliminaUsuario(id, descripcion) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post(main_url + "/admin/conductors/" + id, {
                            _method: "DELETE",
                        })
                        .then((res) => {
                            this.getUsuarios();
