    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Configurar Gestoría de Visa > Configuración</h1>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
        getConfiguracionGestoria() {
            let url = main_url + "/admin/configuracion_gestorias";
            if (this.pagina != 0) {
        ...
        actualizaInformacion() {
            ...
            try {
                let url = main_url + "/admin/configuracion_gestorias";
                axios
                    .post(url, this.oConfiguracionGestoria)
                    .then((res) => {
                        Swal.fire({
                            icon: "success",
                            title: res.data.msj,
        ...
        cargaMapaGoogle(lat, lng, drag = false, dir = "") {
            ...
            google.maps.event.addListener(this.marker, "dragend", () => {
                ...
                this.oConfiguracionGestoria.lat = newPosition.lat();
                this.oConfiguracionGestoria.lng = newPosition.lng();
            });
            ...
            if (dir != "") {
                ...
                this.infowindow = new google.maps.InfoWindow({
                    content: `<strong>DIRECCIÓN:</strong><br>${self.oConfiguracionGestoria.direccion}`,
                });
