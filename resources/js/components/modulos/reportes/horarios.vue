...
export default {
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post(
                    main_url + "/admin/reportes/horarios",
                    this.oReporte,
                    config
                )
                .then((res) => {
        ...
        generaReporteExcel() {
            ...
            axios
                .post("/admin/reportes/horarios_excel", this.oReporte, config)
                .then((response) => {
                    ...
                    fileLink.setAttribute("download", "horarios.xlsx");
