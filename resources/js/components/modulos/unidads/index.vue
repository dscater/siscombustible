...
export default {
    ...
    methods: {
        ...
        editarRegistro(item) {
            ...
            this.oUnidad.descripcion = item.descripcion ? item.descripcion : "";
        ...
        getUnidads() {
            ...
            let url = main_url + "/admin/unidads";
            if (this.pagina != 0) {
        ...
        eliminaUnidad(id, descripcion) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post(main_url + "/admin/unidads/" + id, {
                            _method: "DELETE",
                        })
                        .then((res) => {
                            this.getUnidads();
